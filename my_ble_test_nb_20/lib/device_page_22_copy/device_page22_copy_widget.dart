...
import 'device_page22_copy_model.dart';
export 'device_page22_copy_model.dart';

class DevicePage22CopyWidget extends StatefulWidget {
  const DevicePage22CopyWidget({super.key});

  static String routeName = 'device_page_22Copy';
  static String routePath = '/devicePage22Copy';

  @override
  State<DevicePage22CopyWidget> createState() => _DevicePage22CopyWidgetState();
}

class _DevicePage22CopyWidgetState extends State<DevicePage22CopyWidget> {
  late DevicePage22CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DevicePage22CopyModel());
