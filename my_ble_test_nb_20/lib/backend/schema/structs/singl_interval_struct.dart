...
class SinglIntervalStruct extends BaseStruct {
  SinglIntervalStruct({
    String? icon,
  ...
  static SinglIntervalStruct fromMap(Map<String, dynamic> data) =>
      SinglIntervalStruct(
  ...
  static SinglIntervalStruct? maybeFromMap(dynamic data) => data is Map
      ? SinglIntervalStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SinglIntervalStruct fromSerializableMap(Map<String, dynamic> data) =>
      SinglIntervalStruct(
  ...
  @override
  String toString() => 'SinglIntervalStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is SinglIntervalStruct &&
        icon == other.icon &&
...
SinglIntervalStruct createSinglIntervalStruct({
  String? icon,
  String? temperatureHigtByte,
  String? temperatureLowByte,
  String? timeHour,
