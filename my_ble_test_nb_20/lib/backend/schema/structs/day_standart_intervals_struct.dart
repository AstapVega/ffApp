...
class DayStandartIntervalsStruct extends BaseStruct {
  DayStandartIntervalsStruct({
    String? icon,
  ...
  static DayStandartIntervalsStruct fromMap(Map<String, dynamic> data) =>
      DayStandartIntervalsStruct(
  ...
  static DayStandartIntervalsStruct? maybeFromMap(dynamic data) => data is Map
      ? DayStandartIntervalsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DayStandartIntervalsStruct fromSerializableMap(
  ...
  @override
  String toString() => 'DayStandartIntervalsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DayStandartIntervalsStruct &&
        icon == other.icon &&
...
DayStandartIntervalsStruct createDayStandartIntervalsStruct({
  String? icon,
  String? temperatureHigtByte,
  String? temperatureLowByte,
  String? timeHour,
