...
class MyShedullIntervalsStruct extends BaseStruct {
  MyShedullIntervalsStruct({
    String? icon,
  ...
  static MyShedullIntervalsStruct fromMap(Map<String, dynamic> data) =>
      MyShedullIntervalsStruct(
  ...
  static MyShedullIntervalsStruct? maybeFromMap(dynamic data) => data is Map
      ? MyShedullIntervalsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MyShedullIntervalsStruct fromSerializableMap(
  ...
  @override
  String toString() => 'MyShedullIntervalsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is MyShedullIntervalsStruct &&
        icon == other.icon &&
...
MyShedullIntervalsStruct createMyShedullIntervalsStruct({
  String? icon,
  String? temperatureHigtByte,
  String? temperatureLowByte,
  String? timeHour,
