...
class MyStandartIntervalsStruct extends BaseStruct {
  ...
  static MyStandartIntervalsStruct fromMap(Map<String, dynamic> data) =>
      MyStandartIntervalsStruct(
  ...
  static MyStandartIntervalsStruct? maybeFromMap(dynamic data) => data is Map
      ? MyStandartIntervalsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MyStandartIntervalsStruct fromSerializableMap(
  ...
  @override
  String toString() => 'MyStandartIntervalsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is MyStandartIntervalsStruct &&
        icon == other.icon &&
...
MyStandartIntervalsStruct createMyStandartIntervalsStruct({
  String? icon,
  String? temperatureHigtByte,
  String? temperatureLowByte,
  String? timeHour,
